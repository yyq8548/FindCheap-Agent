...
Current package: **v0.17.32** — primary-field edition matching, consistent snapshot recommendations and goal-scoped recovery consent.
Nine-row comparisons and immutable selections remain.
[Release scope, verification and remaining design gaps](docs/releases/v0.17.32.md).
