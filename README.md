...
Current package: **v0.17.26** — source-bound official URLs and variants, explicit
multi-merchant comparison, visual correction and terminal receipts, and precise single-selection quotes.
[Release scope, verification and remaining design gaps](docs/releases/v0.17.26.md).
