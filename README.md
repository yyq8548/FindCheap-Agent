...
Current source package: **v0.18.7** — recognized Shopify links supply compiled product text to WooCommerce search. The final candidate also prioritizes explicit product categories and forwards visual product type when a top-level type is absent, so flavor or color words do not select clearly conflicting merchant categories. Exact identity and Woo URL security remain enforced. Inspection guidance keeps unreturned capacity, weight and count unknown. This patch includes the earlier search, variant, comparison, recovery and Windows installation repairs. WooCommerce has 1,003 technical search storefronts; registration does not grant merchant trust. Publication, deployment, installation and native acceptance are verified separately in the release record.
Nine-row comparisons and immutable selections remain.
[v0.18.7 release and verification status](docs/releases/v0.18.7.md). [Delivery report and next steps](docs/releases/v0.18.7-completion-report.md). [Native test instructions](docs/engineering/changes/2026-09-09-v0187-native-user-checks.md). [9/9 repair and test status](<改进计划 9_9.md>). [1,000-store baseline evidence](docs/engineering/changes/2026-09-08-woocommerce-expansion-1000-data.md). [Existing 200-merchant trust review](docs/product/woocommerce-merchant-trust-200.md).
