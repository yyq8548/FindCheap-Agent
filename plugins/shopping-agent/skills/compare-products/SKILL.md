...
description: Search a bounded audited Shopify Storefront registry first, verify same-product identity, and render MCP UI product cards, Coupon status, and safe purchase links before authorized Chrome fallback. Checkout and payment remain out of scope in v0.3.6.
---

# FindCheap-Agent v0.3.6 reliable MCP UI product cards
