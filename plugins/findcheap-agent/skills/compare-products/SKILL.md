...
# FindCheap Agent v0.15.4 Product Search
...
4. Tool searches Awin, Shopify, eBay and verified official store. Official identity never bypasses relevance. Preserve returned order: verified official matches (maximum 2), trusted high matches, best-value high matches. Approved Awin merchants are trusted; commission never changes relevance. Hide diagnostics.
