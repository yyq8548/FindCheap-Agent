...
describe("managed merchant trust registry", () => {
  it("cancels one caller without poisoning the shared refresh or its cache", async () => {
    ...
    const port = createMerchantTrustRegistryPortFromEnvironment({ AWIN_PRODUCT_SEARCH_URL: "https://findcheap.example/v1/search" },
