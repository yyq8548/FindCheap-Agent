...
- 搜索结果分成三组。第一组只接受托管在已独立验证品牌官网上的商品，最多两张卡片。第二组接受可信注册表商家，或评分高于 `3.8` 且至少有 `2` 条评价的高匹配 Shopify 商品。联盟批准本身不会把商家提升到这一组。其他相关商品进入高性价比组，并明确提示商家可信证据有限。商品评分不能独立证明商家可信。标记为 `RISKY` 的域名会直接排除。
- Awin 批准只确认当前配置的联盟计划和链接路径，不代表平台独立认可该商家或商品。商业关系不影响来源资格、商家层级、相关性或排序。
