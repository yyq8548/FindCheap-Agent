...
| WooCommerce 独立来源 | 可选跨店聚合、首轮搜索、精确变体、混合比较、优惠与 Watch；访问表与信任表隔离；商品价不等于到手价 | v0.18.1 生产保留 [200 家访问表](../product/woocommerce-merchants-200.md)，另已审核发布 [137 家官网、45 家可信零售](../product/woocommerce-merchant-trust-200.md)，18 家保留搜索资格；每轮最多 6 家／每次检索最多两轮；来源端点和已安装 SDK 已验证，原生图片／选择及真实 Watch 生命周期仍独立验收 |
